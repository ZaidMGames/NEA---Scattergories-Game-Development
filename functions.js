...
export const ListOfCategories = [
  ...
  new Category("Famous Landmark"),
  new Category("Greek God/Goddess"),
  new Category("Holiday"),
  new Category("Instrument"),
  new Category("Junk Food"),
  new Category("Kitchen Appliance"),
  new Category("Literary Character"),
  new Category("Musical Genre"),
  new Category("Nationality"),
  new Category("Ocean"),
  new Category("Plant"),
  new Category("Quotation"),
  new Category("Rock Band"),
  new Category("Sport"),
  new Category("TV Show"),
